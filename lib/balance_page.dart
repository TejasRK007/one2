...
class BalancePage extends StatelessWidget {
  ...
  Future<DatabaseReference> _getBalanceRef() async {
    return FirebaseDatabase.instance.ref().child('users/$phone/balance');
  }
